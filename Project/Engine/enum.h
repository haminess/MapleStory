...
{
	TRANSFORM,			// [Object] 위치, 크기, 회전, 부모자식 계층구조
	COLLIDER2D,			// 2D 충돌체
	COLLIDER3D,			// 3D 충돌체
	RIGIDBODY2D,		// 2D 중력
...
enum class TASK_TYPE
{
	...
	// 0 : Func Address, 1 : Param, 2: Param
	INVOKE_PARAM1,

	// 0 : Func Address, 1 : Param1, 2: Param2
	INVOKE_PARAM2,
